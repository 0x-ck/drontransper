#!/home/xb344575/careerxrosspoint.com/.venv/bin/env python
...
SECRET_KEY = 'django-insecure-mtphgx%%^==qsx)zl+ojqy_5+tj_loam_7k2x3_k4pcgz8(w$('
...
if ON_SERVER:
    ...
    EMAIL_BACKEND = 'homepage.backend.LoggingEmailBackend'
